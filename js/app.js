...
var countries = ['Thailand', 'France', 'Great Britain', 'Spain', 'Portugal', 'Israel', 'Egypt', 'Greece', 'China', 'Romania', 'Australia'];
...
for (var i = 0; i < countries.length; i++) {
  if (countryGuess === countries[i]) {
    alert('Correct your score is ' + quizScore + ' out of 6');
    break;
  } else {
    alert ('Incorrect, your score is ' + quizScore + ' out of 6');
    questionCount++;
  }
  
  if (questionCount === 6) {
    alert ('Out of attempts, hope you had fun!');
    break;
  }
}